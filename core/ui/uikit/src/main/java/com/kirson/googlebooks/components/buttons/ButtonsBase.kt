...
internal fun ButtonText(
  ...
  Text(
    ...
    style = when (size) {
        ButtonSize.Normal -> GoogleBooksTheme.typography.button1
        ButtonSize.Small -> GoogleBooksTheme.typography.button2
    },
    text = text,
  )
}
...
internal object ButtonDefaults {
  ...
  fun primaryButtonColors(): ButtonColors {
    return ButtonColors(
        ...
        contentColor = GoogleBooksTheme.colors.primaryButton,
        disabledBackgroundColor = GoogleBooksTheme.colors.textTertiary,
        disabledContentColor = GoogleBooksTheme.colors.textTertiary,
    )
  }
  ...
  fun secondaryButtonColors(): ButtonColors {
    return ButtonColors(
        backgroundColor = GoogleBooksTheme.colors.contendSecondary,
        contentColor = GoogleBooksTheme.colors.textPrimary,
        disabledBackgroundColor = GoogleBooksTheme.colors.contendSecondary,
        disabledContentColor = GoogleBooksTheme.colors.textTertiary,
    )
  }
  ...
  fun positiveButtonColors(): ButtonColors {
    return ButtonColors(
        backgroundColor = Color.Transparent,
        contentColor = GoogleBooksTheme.colors.textPrimary,
        disabledBackgroundColor = GoogleBooksTheme.colors.contendTertiary,
        disabledContentColor = GoogleBooksTheme.colors.textTertiary,
    )
  }
  ...
  fun topAppBarButtonColors(
      contentColor: Color = GoogleBooksTheme.colors.textPrimary,
  ): ButtonColors {
    return ButtonColors(
        backgroundColor = Color.Transparent,
  ...
  fun unselectedChipButtonColors(): ButtonColors {
    return ButtonColors(
        backgroundColor = Color.Transparent,
        contentColor = GoogleBooksTheme.colors.textSecondary,
        disabledBackgroundColor = Color.Transparent,
        disabledContentColor = GoogleBooksTheme.colors.textTertiary,
    )
  }
