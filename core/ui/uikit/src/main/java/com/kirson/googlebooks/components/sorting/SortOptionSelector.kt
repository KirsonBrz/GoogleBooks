...
import com.kirson.googlebooks.components.buttons.SecondaryButton
...
fun SortOptionSelector(
  ...
  Column(
    modifier = modifier
        .background(GoogleBooksTheme.colors.backgroundPrimary)
      ...
      SecondaryButtonSmall(
        ...
        icon = {
          ...
          Icon(
              ...
              tint = GoogleBooksTheme.colors.textPrimary,
          )
        },
